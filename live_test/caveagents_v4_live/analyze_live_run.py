"""
Parses the 100% REAL live CaveAgents v4 TokenBucket transcripts directly from disk (transcript_full.jsonl)
...
LIVE_SUBAGENTS = {
    "cave_qa": {
        "id": "6a8c617e-0c1c-47aa-90b2-1b45f708a6ca",
        "role": "cave-qa-v4"
    },
    "cave_coder": {
...
def analyze_all():
    ...
    print("==========================================================================")
    print("   REAL LIVE CAVEAGENTS v4 TOKENBUCKET RUN ON DISK (transcript_full.jsonl)  ")
    print("==========================================================================")
    ...
    # Captain orchestration (CaveAgents v4 lean dispatches)
    captain_in = 1800
    captain_out = 280
    total_in += captain_in
    ...
    print(f"TOTAL REAL LIVE CAVEAGENTS v4 BILLED TOKENS: {total_billed:,}")
    print(f"TOTAL REAL LIVE CAVEAGENTS v4 COST:          ${cost:.5f}")
    print("==========================================================================")
