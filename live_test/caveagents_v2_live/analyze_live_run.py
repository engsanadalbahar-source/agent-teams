"""
Parses the 100% REAL live CaveAgents v2 TokenBucket transcripts directly from disk (transcript_full.jsonl)
...
LIVE_SUBAGENTS = {
    "cave_qa": {
        "id": "ee34719a-b12c-4055-97c5-c9862e408b66",
        "role": "cave-qa"
    },
    "cave_coder": {
        "id": "e96f0467-7039-4b53-bab1-8e19abb130c5",
        "role": "cave-coder"
    },
    "cave_reviewer": {
        "id": "ea071eb7-e7d2-4afc-8c88-5296e304e45b",
        "role": "cave-reviewer"
    }
}
...
def analyze_all():
    ...
    print("==========================================================================")
    print("   REAL LIVE CAVEAGENTS v2 TOKENBUCKET RUN ON DISK (transcript_full.jsonl)  ")
    print("==========================================================================")
    ...
    # Captain orchestration (CaveAgents v2 terse dispatches)
    captain_in = 2600
    captain_out = 380
    total_in += captain_in
    ...
    print(f"TOTAL REAL LIVE CAVEAGENTS v2 BILLED TOKENS: {total_billed:,}")
    print(f"TOTAL REAL LIVE CAVEAGENTS v2 COST:          ${cost:.5f}")
    print("==========================================================================")
